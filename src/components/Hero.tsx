    ...
    <section className="relative min-h-[90vh] lg:min-h-[94vh] flex items-center justify-center bg-zinc-950 text-white overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="The Foldaway aluminium washing line opened on exterior wall"
          fill
          priority
          className="object-cover object-center opacity-85 scale-105 transform"
          sizes="100vw"
        />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 w-full">
        <div className="max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-semibold tracking-widest text-zinc-300 uppercase mb-6">
          ...
          <p className="mt-4 text-2xl sm:text-3xl font-light tracking-tight text-zinc-200 leading-snug">
            {PRODUCT_DATA.brand.heroSubtitle}
          </p>

          <p className="mt-6 text-base sm:text-lg text-zinc-300 font-normal leading-relaxed max-w-xl">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
            <Link
              href="/#order"
              className="inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-xl bg-white text-zinc-950 font-bold text-xs uppercase tracking-wider hover:bg-zinc-100 active:scale-[0.98] transition-all shadow-lg hover:shadow-xl"
            >
          ...
          <div className="mt-12 pt-8 border-t border-white/15 grid grid-cols-2 sm:grid-cols-3 gap-4 text-xs text-zinc-300">
            ...
            <div className="flex items-center gap-2 col-span-2 sm:col-span-1">
              ...
              <span className="font-medium">Stainless Steel Screws</span>
            </div>
          </div>
        </div>
      </div>
